...
// Mon Mar 24 15:44:05 2025 by ROOT version 6.30/03
// from TTree Events/Events
// found on file: ZmumuKBMTF_DY.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ZmumuKBMTF_DY.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ZmumuKBMTF_DY.root");
      }
