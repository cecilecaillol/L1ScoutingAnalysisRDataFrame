...
def add_lumi():
    ...
    lumi.SetTextFont (   42 )
    lumi.AddText("5.4 fb^{#minus1} (13.6 TeV)")
    return lumi
...
Data=myfile.Get("nstub_OS").Get("data_obs").Clone()
DY=myfile.Get("nstub_OS").Get("DY").Clone()
Fake=myfile.Get("nstub_OS").Get("Fake").Clone()
...
#   Rare.SetFillColor(ROOT.TColor.GetColor("#9c9ca1"))
#   ZZ.SetFillColor(ROOT.TColor.GetColor("#7a21dd"))
#   ZG.SetFillColor(ROOT.TColor.GetColor("#e42536"))
#   Nonprompt.SetFillColor(ROOT.TColor.GetColor("#f89c20"))
#   chargemisid.SetFillColor(ROOT.TColor.GetColor("#964a8b"))
...
lumi1.AddText("|#eta| < 0.83, p_{T} > 8 GeV")
lumi1.Draw("same")
...
ROOT.gPad.RedrawAxis()
c.Modified()
c.SaveAs("plots/"+args.selection+"_OS_nstubs.pdf")
c.SaveAs("plots/"+args.selection+"_OS_nstubs.png")
