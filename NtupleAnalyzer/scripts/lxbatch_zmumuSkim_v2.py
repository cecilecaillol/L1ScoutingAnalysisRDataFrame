...
output_dir = "/eos/cms/store/group/cmst3/group/slowmuons/ZmumuSkims"
exe_script = "/afs/cern.ch/work/c/ccaillol/L1ScoutingAnalysisRDataFrame/CMSSW_14_0_12/src/L1ScoutingAnalysisRDataFrame/NtupleAnalyzer/scripts/FinalSelection_Zmumu.py"
...
for input_file in os.listdir(input_dir):
    if input_file.endswith(".root"):
        ...
        wrapper_script = f"wrappers/wrapper_{job_name}.sh"
...
""")
        ...
        submit_file = f"submit_{job_name}.sub"
